...
/*------------------------------------- Global RTL Check -------------------------------------*/
// This checks if the HTML tag has dir="rtl" (which you set in index.ar.html)
...
$('.slider-main').slick({
    ...
    autoplay: true,
    arrows: false,
    rtl: isRtl // Added RTL support here
})
...
$(document).ready(function () {
    $('.services_slider').slick({
        ...
        dots: false,
        speed: 1500,
        rtl: isRtl, // Added RTL support here - CRITICAL for Arabic
        responsive: [
            {
                breakpoint: 1199,
                settings: {
...
const topButton = document.querySelector('.bottom-top-button');
if(topButton) {
...
jQuery(document).ready(function () {
    jQuery(document).on('scroll', function () {
        // Check if element exists before getting height
        if (jQuery('#first-sec').length) {
